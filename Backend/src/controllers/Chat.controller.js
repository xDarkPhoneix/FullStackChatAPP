...
const createGroupChat=asynchandler(async(req,res)=>{
 ...
 res.status(201).json(
  new ApiResponse(200,fullchat,"Group Chat created sucessfully")
 )
...
const renameGroup=asynchandler(async(req,res)=>{
 ...
 const updatedChat= await Chats.findByIdAndUpdate(
  ...
  res.status(201).json(new ApiResponse(200,updatedChat,"chatName updated successfully"))
...
const addToGroup=asynchandler(async(req,res)=>{
  ...
  const newCHat=  await Chats.findByIdAndUpdate(
    ...
    if(!newCHat){
     ...
     res.status(201).json(new ApiResponse(200,newCHat,"Member add to group sucessfully"))
...
const newCHat=  await Chats.findByIdAndUpdate(
  ...
  if(!newCHat){
   ...
   res.status(201).json(new ApiResponse(200,newCHat,"Member removed from group sucessfully"))
